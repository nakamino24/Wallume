    ...
    >
      ...
      <FlexWidget style={{ width: 'match_parent', marginTop: 4 }}>
        ...
        <FlexWidget style={{ width: 'match_parent', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <FlexWidget style={{ width: 46, height: 46, alignItems: 'center', justifyContent: 'center' }} clickAction="TOGGLE_WIDGET_BALANCE" accessibilityLabel={id ? 'Tampilkan atau sembunyikan saldo widget' : 'Show or hide widget balance'}>
            <IconWidget icon={data.isBalanceVisible === true ? WIDGET_EYE_ICON : WIDGET_EYE_OFF_ICON} font="Ionicons" size={18} style={{ color: WHITE }} />
          </FlexWidget>
        </FlexWidget>
